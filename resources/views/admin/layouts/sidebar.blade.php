...
<li class="nav-item dd {{ Request::is('admin/fun-fact/*')||Request::is('admin/marquee/*')||Request::is('admin/offer/*')||Request::is('admin/call-to-action/*')||Request::is('admin/welcome-one/*')||Request::is('admin/video-one/*')||Request::is('admin/feature-one/*')||Request::is('admin/why-choose-one/*') ? 'active' : '' }}">
    ...
    <div id="collapse_all_sections" class="collapse {{ Request::is('admin/fun-fact/*')||Request::is('admin/marquee/*')||Request::is('admin/offer/*')||Request::is('admin/call-to-action/*')||Request::is('admin/welcome-one/*')||Request::is('admin/video-one/*')||Request::is('admin/feature-one/*')||Request::is('admin/why-choose-one/*') ? 'show' : '' }}" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
