...
class FrontController extends Controller
{
    ...
    public function home()
    {
        ...
        // Cek jika 'home_show' adalah 'Home 1', arahkan ke view 'home-1'
        if ($setting->home_show == 'Home 1') {
            return view('front.home-1', $this->home_data());
        }
    
        // Tambahkan fallback jika pengaturan tidak cocok
        return view('front.home-1', $this->home_data());  // Default ke Home 1
    }
