...
class AdminController extends Controller
{
    ...
    public function profile_update(Request $request)
    {
        ...
        public function index()
        {
            ...
            return view('admin.admin.index', compact('admins')); // Return ke view
        }
        ...
        public function store(Request $request)
        {
            ...
            if ($request->hasFile('photo')) {
                ...
                $admin->photo = $filename; // Simpan nama file ke database
            }
        ...
        // Mengupdate data admin yang ada
        public function update(Request $request, $id)
        {
            ...
            if ($request->hasFile('photo')) {
                ...
                $filename = time() . '_' . $file->getClientOriginalName();
                $file->move(public_path('uploads'), $filename);
                $admin->photo = $filename; // Simpan nama file baru ke database
            }
        ...
        public function destroy($id)
        {
            ...
            // Menghapus file foto jika ada dan file tersebut benar-benar ada di folder
            if ($admin->photo && file_exists(public_path('uploads/' . $admin->photo))) {
                unlink(public_path('uploads/' . $admin->photo)); // Hapus file foto
            }

            $admin->delete(); // Hapus data admin dari database
